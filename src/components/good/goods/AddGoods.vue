  ...
  <div id="add-goods">
    <el-dialog :visible.sync="addVisible" width="60%" height="60%" @close="addClosed()">
      ...
      <el-form :model="addForm" :rules="Rules" ref="addFormRef" label-width="100px">
        <el-tabs :tab-position="tabPosition" v-model="activeIndex" :before-leave="changeTabs" @tab-click="tabsClick()">
          <!---------- 基本信息标签页 ---------->
          <el-tab-pane label="基本信息" name="0">
            <!-- 级联选择器: options指定数据源/props指定配置对象/v-model绑定存储的数组(必须是数组) -->
            <el-form-item label="商品分类" prop="goods_cat">
              <el-cascader :options="cateList" :props="cascaderProps" v-model="addForm.goods_cat" clearable placeholder="请选择商品分类" @change="cateChanged()"> </el-cascader>
            </el-form-item>
          ...
          <el-tab-pane label="商品图片" name="3">
            ...
            <el-upload :action="actionURL" :on-preview="handlePreview" :on-remove="handleRemove" list-type="picture" :headers="headerObj" :on-success="handleSuccess">
...
export default {
  ...
  data() {
    return {
      ...
      actionURL: 'http://shiyansong.cn:8888/api/private/v1/upload', //图片上传的完整地址 (baseURL + API)
